...
const Formulario = () => {
  ...
  justifyContent='space-around'>
    ...
    mb='80px'>
      ...
      pb='20px'>Dejame tu consulta</Text>
      <div class="Formulario-completo">
      <div class="NombreEmail">
       <Flex 
        m='10px'
        borderRadius='5px'>
      <Input border='solid gray 1px'  variant='outline' placeholder="Nombre" type="text"/> 
      <Input border='solid gray 1px' variant='outline' placeholder="Email" type="email"/>
     </Flex>
    ...
    m='10px'
    borderRadius='5px'>
      <Input  border='solid gray 1px' variant='outline' placeholder="Numero" type="tel"/>
      <Input border='solid gray 1px' variant='outline' placeholder="Presupuesto" type="text"/>
      </Flex>
    </div>
    <Input border='solid gray 1px' variant='outline' placeholder="Mensaje" minlength="10" type="text"/>
